package com.example.application.views.detallesempleados;
...
@PageTitle("Detalles Empleados")
@Route("grid-with-filters")
@Menu(order = 2, icon = LineAwesomeIconUrl.FILTER_SOLID)
@PermitAll
@Uses(Icon.class)
public class DetallesEmpleadosView extends Div {
    ...
    public DetallesEmpleadosView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("detalles-empleados-view");
